...
enum opt_code
{
  ...
  OPT_fdse = 669,                            /* -fdse */
  OPT_fdump_ = 670,                          /* -fdump- */
  OPT_fdump_ada_spec = 671,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 672,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 673, */                /* -fdump-core */
  OPT_fdump_d_original = 674,                /* -fdump-d-original */
  OPT_fdump_final_insns = 675,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 676,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 677,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 678,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 679,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 680,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 681,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 682, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 683,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 684,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 685,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 686,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 687,                 /* -fearly-inlining */
  OPT_felide_constructors = 688,             /* -felide-constructors */
  OPT_felide_type = 689,                     /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 690, */    /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 691, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 692,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 693,        /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 694,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 695,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 696,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 697,                        /* -fenable- */
  OPT_fenforce_eh_specs = 698,               /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 699,                 /* -fenum-int-equiv */
  OPT_fexceptions = 700,                     /* -fexceptions */
  OPT_fexcess_precision_ = 701,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 702,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 703,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 704,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 705,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 706,                /* -fextern-tls-init */
  OPT_fexternal_blas = 707,                  /* -fexternal-blas */
  OPT_fexternal_templates = 708,             /* -fexternal-templates */
  OPT_ff2c = 709,                            /* -ff2c */
  OPT_ffast_math = 710,                      /* -ffast-math */
  OPT_ffat_lto_objects = 711,                /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 712,               /* -ffile-prefix-map= */
  OPT_ffinite_math_only = 713,               /* -ffinite-math-only */
  OPT_ffixed_ = 714,                         /* -ffixed- */
  OPT_ffixed_form = 715,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 716,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 717,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 718,                    /* -ffloat-store */
  OPT_ffor_scope = 719,                      /* -ffor-scope */
  /* OPT_fforce_addr = 720, */               /* -fforce-addr */
  OPT_fforward_propagate = 721,              /* -fforward-propagate */
  OPT_ffp_contract_ = 722,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 723,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 724,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 725,                      /* -ffpe-trap= */
  OPT_ffree_form = 726,                      /* -ffree-form */
  OPT_ffree_line_length_ = 727,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 728,          /* -ffree-line-length-none */
  OPT_ffreestanding = 729,                   /* -ffreestanding */
  OPT_ffriend_injection = 730,               /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 731,      /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 732,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 733,                   /* -ffunction-cse */
  OPT_ffunction_sections = 734,              /* -ffunction-sections */
  OPT_fgcse = 735,                           /* -fgcse */
  OPT_fgcse_after_reload = 736,              /* -fgcse-after-reload */
  OPT_fgcse_las = 737,                       /* -fgcse-las */
  OPT_fgcse_lm = 738,                        /* -fgcse-lm */
  OPT_fgcse_sm = 739,                        /* -fgcse-sm */
  OPT_fgimple = 740,                         /* -fgimple */
  OPT_fgnat_encodings_ = 741,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 742,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 743,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 744,                         /* -fgnu-tm */
  OPT_fgnu_unique = 745,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 746,                   /* -fgnu89-inline */
  OPT_fgo_c_header_ = 747,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 748,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 749,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 750,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 751,                /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 752,          /* -fgo-debug-escape-hash= */
  OPT_fgo_dump_ = 753,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 754,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 755,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 756,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 757,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 758,                       /* -fgraphite */
  OPT_fgraphite_identity = 759,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 760,       /* -fguess-branch-probability */
  OPT_fguiding_decls = 761,                  /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 762, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 763, */                     /* -fhelp */
  /* OPT_fhelp_ = 764, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 765,           /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 766,                      /* -fhonor-std */
  OPT_fhosted = 767,                         /* -fhosted */
  OPT_fhuge_objects = 768,                   /* -fhuge-objects */
  OPT_fident = 769,                          /* -fident */
  OPT_fif_conversion = 770,                  /* -fif-conversion */
  OPT_fif_conversion2 = 771,                 /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 772,         /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 773,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 774,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 775,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 776,             /* -fimplicit-templates */
  OPT_findirect_inlining = 777,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 778,         /* -finhibit-size-directive */
  OPT_finit_character_ = 779,                /* -finit-character= */
  OPT_finit_derived = 780,                   /* -finit-derived */
  OPT_finit_integer_ = 781,                  /* -finit-integer= */
  OPT_finit_local_zero = 782,                /* -finit-local-zero */
  OPT_finit_logical_ = 783,                  /* -finit-logical= */
  OPT_finit_real_ = 784,                     /* -finit-real= */
  OPT_finline = 785,                         /* -finline */
  OPT_finline_atomics = 786,                 /* -finline-atomics */
  OPT_finline_functions = 787,               /* -finline-functions */
  OPT_finline_functions_called_once = 788,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 789, */            /* -finline-limit- */
  OPT_finline_limit_ = 790,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 791,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 792,         /* -finline-small-functions */
  OPT_finput_charset_ = 793,                 /* -finput-charset= */
  OPT_finstrument_functions = 794,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 795,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 796,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 797,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 798,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 799,        /* -fintrinsic-modules-path= */
  OPT_finvariants = 800,                     /* -finvariants */
  OPT_fipa_bit_cp = 801,                     /* -fipa-bit-cp */
  OPT_fipa_cp = 802,                         /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 803, */         /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 804,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 805,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 806,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 807,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 808, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 809,                    /* -fipa-profile */
  OPT_fipa_pta = 810,                        /* -fipa-pta */
  OPT_fipa_pure_const = 811,                 /* -fipa-pure-const */
  OPT_fipa_ra = 812,                         /* -fipa-ra */
  OPT_fipa_reference = 813,                  /* -fipa-reference */
  OPT_fipa_reference_addressable = 814,      /* -fipa-reference-addressable */
  OPT_fipa_sra = 815,                        /* -fipa-sra */
  OPT_fipa_stack_alignment = 816,            /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 817, */         /* -fipa-struct-reorg */
  OPT_fipa_vrp = 818,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 819,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 820,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 821,              /* -fira-loop-pressure */
  OPT_fira_region_ = 822,                    /* -fira-region= */
  OPT_fira_share_save_slots = 823,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 824,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 825,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 826,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 827,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 828,               /* -fivar-visibility= */
  OPT_fivopts = 829,                         /* -fivopts */
  OPT_fjump_tables = 830,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 831,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 832,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 833,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 834,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 835,          /* -fkeep-static-functions */
  OPT_flabels_ok = 836,                      /* -flabels-ok */
  OPT_flax_vector_conversions = 837,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 838,             /* -fleading-underscore */
  OPT_flifetime_dse = 839,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 840,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 841,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 842,                 /* -flinker-output= */
  /* OPT_flive_patching = 843, */            /* -flive-patching */
  OPT_flive_patching_ = 844,                 /* -flive-patching= */
  ...
  OPT_fmacro_prefix_map_ = 865,              /* -fmacro-prefix-map= */
  OPT_fmain = 866,                           /* -fmain */
  OPT_fmath_errno = 867,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 868,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 869,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 870,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 871,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 872,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 873,                     /* -fmem-report */
  OPT_fmem_report_wpa = 874,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 875,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 876,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 877,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 878,                /* -fmessage-length= */
  OPT_fmodule_file_ = 879,                   /* -fmodule-file= */
  OPT_fmodule_private = 880,                 /* -fmodule-private */
  OPT_fmoduleinfo = 881,                     /* -fmoduleinfo */
  OPT_fmodulo_sched = 882,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 883,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 884,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 885,                  /* -fms-extensions */
  OPT_fmudflap = 886,                        /* -fmudflap */
  OPT_fmudflapir = 887,                      /* -fmudflapir */
  OPT_fmudflapth = 888,                      /* -fmudflapth */
  OPT_fname_mangling_version_ = 889,         /* -fname-mangling-version- */
  OPT_fnew_abi = 890,                        /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 891,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 892,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 893,                   /* -fnext-runtime */
  OPT_fnil_receivers = 894,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 895,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 896,               /* -fnonansi-builtins */
  OPT_fnonnull_objects = 897,                /* -fnonnull-objects */
  OPT_fnothrow_opt = 898,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 899,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 900,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 901,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 902,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 903,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 904,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 905,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 906,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 907,                   /* -foffload-abi= */
  OPT_foffload_ = 908,                       /* -foffload= */
  OPT_fomit_frame_pointer = 909,             /* -fomit-frame-pointer */
  OPT_fonly_ = 910,                          /* -fonly= */
  OPT_fopenacc = 911,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 912,                   /* -fopenacc-dim= */
  OPT_fopenmp = 913,                         /* -fopenmp */
  OPT_fopenmp_simd = 914,                    /* -fopenmp-simd */
  OPT_foperator_names = 915,                 /* -foperator-names */
  OPT_fopt_info = 916,                       /* -fopt-info */
  OPT_fopt_info_ = 917,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 918, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 919,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 920,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 921, */           /* -foptional-diags */
  OPT_fpack_derived = 922,                   /* -fpack-derived */
  OPT_fpack_struct = 923,                    /* -fpack-struct */
  OPT_fpack_struct_ = 924,                   /* -fpack-struct= */
  OPT_fpad_source = 925,                     /* -fpad-source */
  OPT_fpartial_inlining = 926,               /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 927,      /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 928,              /* -fpcc-struct-return */
  OPT_fpch_deps = 929,                       /* -fpch-deps */
  OPT_fpch_preprocess = 930,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 931,                     /* -fpeel-loops */
  OPT_fpeephole = 932,                       /* -fpeephole */
  OPT_fpeephole2 = 933,                      /* -fpeephole2 */
  OPT_fpermissive = 934,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 935,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 936,                            /* -fpic */
  OPT_fpie = 937,                            /* -fpie */
  OPT_fplan9_extensions = 938,               /* -fplan9-extensions */
  OPT_fplt = 939,                            /* -fplt */
  OPT_fplugin_arg_ = 940,                    /* -fplugin-arg- */
  OPT_fplugin_ = 941,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 942,            /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 943,                 /* -fpostconditions */
  OPT_fpre_include_ = 944,                   /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 945,             /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 946,                  /* -fpreconditions */
  OPT_fpredictive_commoning = 947,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 948,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 949,                   /* -fpreprocessed */
  OPT_fpretty_templates = 950,               /* -fpretty-templates */
  OPT_fprintf_return_value = 951,            /* -fprintf-return-value */
  OPT_fprofile = 952,                        /* -fprofile */
  OPT_fprofile_abs_path = 953,               /* -fprofile-abs-path */
  OPT_fprofile_arcs = 954,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 955,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 956,                   /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 957,         /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 958,          /* -fprofile-filter-files= */
  OPT_fprofile_generate = 959,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 960,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 961,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 962,                 /* -fprofile-report */
  OPT_fprofile_update_ = 963,                /* -fprofile-update= */
  OPT_fprofile_use = 964,                    /* -fprofile-use */
  OPT_fprofile_use_ = 965,                   /* -fprofile-use= */
  OPT_fprofile_values = 966,                 /* -fprofile-values */
  OPT_fprotect_parens = 967,                 /* -fprotect-parens */
  OPT_frandom_seed = 968,                    /* -frandom-seed */
  OPT_frandom_seed_ = 969,                   /* -frandom-seed= */
  OPT_frange_check = 970,                    /* -frange-check */
  OPT_freal_4_real_10 = 971,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 972,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 973,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 974,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 975,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 976,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 977,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 978,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 979,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 980,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 981,                /* -frecord-marker=8 */
  OPT_frecursive = 982,                      /* -frecursive */
  OPT_free = 983,                            /* -free */
  OPT_freg_struct_return = 984,              /* -freg-struct-return */
  /* OPT_fregmove = 985, */                  /* -fregmove */
  OPT_frelease = 986,                        /* -frelease */
  OPT_frename_registers = 987,               /* -frename-registers */
  OPT_freorder_blocks = 988,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 989,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 990,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 991,              /* -freorder-functions */
  OPT_frepack_arrays = 992,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 993,           /* -freplace-objc-classes */
  OPT_frepo = 994,                           /* -frepo */
  OPT_freport_bug = 995,                     /* -freport-bug */
  OPT_frequire_return_statement = 996,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 997,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 998, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 999,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1000,                   /* -fresolution= */
  OPT_frounding_math = 1001,                 /* -frounding-math */
  OPT_frtti = 1002,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1003,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1004,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1005,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1006,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1007,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1008,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1009,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1010,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1011, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1012,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1013,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1014,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1015,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1016,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1017,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1018,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1019,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1020,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1021,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1022,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1023,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1024,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1025,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1026,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1027,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1028, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1029,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1030,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1031,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1032,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1033,               /* -fsection-anchors */
  /* OPT_fsee = 1034, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1035,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1036,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1037,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1038,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1039,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1040,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1041,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1042,                   /* -fshort-enums */
  OPT_fshort_wchar = 1043,                   /* -fshort-wchar */
  OPT_fshow_column = 1044,                   /* -fshow-column */
  OPT_fshrink_wrap = 1045,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1046,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1047,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1048,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1049,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1050,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1051,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1052,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1053,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1054,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1055,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1056,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1057,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1058,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1059,              /* -fsplit-wide-types */
  OPT_fsquangle = 1060,                      /* -fsquangle */
  OPT_fssa_backprop = 1061,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1062,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1063,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1064,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1065, */             /* -fstack-check */
  OPT_fstack_check_ = 1066,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1067,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1068,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1069,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1070,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1071,               /* -fstack-protector */
  OPT_fstack_protector_all = 1072,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1073,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1074,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1075,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1076,                   /* -fstack-usage */
  OPT_fstats = 1077,                         /* -fstats */
  OPT_fstdarg_opt = 1078,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1079,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1080, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1081,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1082,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1083,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1084,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1085,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1086, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1087,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1088,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1089,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1090,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1091,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1092, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1093,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1094, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1095,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1096,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1097,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1098,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1099,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1100,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1101,                   /* -ftime-report */
  OPT_ftime_report_details = 1102,           /* -ftime-report-details */
  OPT_ftls_model_ = 1103,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1104,              /* -ftoplevel-reorder */
  OPT_ftracer = 1105,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1106,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1107,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1108,                   /* -ftrampolines */
  OPT_ftransition_all = 1109,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1110,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1111,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1112,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1113,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1114,              /* -ftransition=field */
  OPT_ftransition_import = 1115,             /* -ftransition=import */
  OPT_ftransition_nogc = 1116,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1117,                /* -ftransition=tls */
  OPT_ftrapping_math = 1118,                 /* -ftrapping-math */
  OPT_ftrapv = 1119,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1120,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1121,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1122,                      /* -ftree-ccp */
  OPT_ftree_ch = 1123,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1124, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1125,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1126,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1127, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1128,                   /* -ftree-cselim */
  OPT_ftree_dce = 1129,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1130,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1131,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1132,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1133,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1134, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1135,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1136,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1137, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1138,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1139,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1140, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1141,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1142,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1143,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1144,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1145,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1146,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1147,                      /* -ftree-pre */
  OPT_ftree_pta = 1148,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1149,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1150, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1151,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1152,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1153,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1154,                     /* -ftree-slsr */
  OPT_ftree_sra = 1155,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1156, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1157, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1158,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1159,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1160,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1161, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1162,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1163, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1164,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1165,         /* -funconstrained-commons */
  OPT_funderscoring = 1166,                  /* -funderscoring */
  OPT_funit_at_a_time = 1167,                /* -funit-at-a-time */
  OPT_funittest = 1168,                      /* -funittest */
  OPT_funroll_all_loops = 1169,              /* -funroll-all-loops */
  OPT_funroll_loops = 1170,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1171, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1172,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1173,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1174,                 /* -funsigned-char */
  OPT_funswitch_loops = 1175,                /* -funswitch-loops */
  OPT_funwind_tables = 1176,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1177,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1178,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1179,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1180,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1181,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1182,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1183,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1184,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1185,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1186,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1187,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1188, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1189,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1190,                   /* -fverbose-asm */
  /* OPT_fversion = 1191, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1192,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1193,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1194,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1195,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1196,                   /* -fvisibility= */
  OPT_fvpt = 1197,                           /* -fvpt */
  OPT_fvtable_gc = 1198,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1199,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1200,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1201,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1202,                     /* -fvtv-debug */
  OPT_fweak = 1203,                          /* -fweak */
  OPT_fweb = 1204,                           /* -fweb */
  /* OPT_fwhole_file = 1205, */              /* -fwhole-file */
  OPT_fwhole_program = 1206,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1207,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1208,             /* -fworking-directory */
  OPT_fwpa = 1209,                           /* -fwpa */
  OPT_fwpa_ = 1210,                          /* -fwpa= */
  OPT_fwrapv = 1211,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1212,                 /* -fwrapv-pointer */
  OPT_fxref = 1213,                          /* -fxref */
  /* OPT_fzee = 1214, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1215,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1216,                     /* -fzero-link */
  OPT_g = 1217,                              /* -g */
  OPT_gant = 1218,                           /* -gant */
  OPT_gas_loc_support = 1219,                /* -gas-loc-support */
  OPT_gas_locview_support = 1220,            /* -gas-locview-support */
  OPT_gcoff = 1221,                          /* -gcoff */
  OPT_gcoff1 = 1222,                         /* -gcoff1 */
  OPT_gcoff2 = 1223,                         /* -gcoff2 */
  OPT_gcoff3 = 1224,                         /* -gcoff3 */
  OPT_gcolumn_info = 1225,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1226,                 /* -gdescribe-dies */
  OPT_gdwarf = 1227,                         /* -gdwarf */
  OPT_gdwarf_ = 1228,                        /* -gdwarf- */
  OPT_gen_decls = 1229,                      /* -gen-decls */
  OPT_ggdb = 1230,                           /* -ggdb */
  OPT_ggnu_pubnames = 1231,                  /* -ggnu-pubnames */
  OPT_ginline_points = 1232,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1233, /* -ginternal-reset-location-views */
  OPT_gnat = 1234,                           /* -gnat */
  OPT_gnatO = 1235,                          /* -gnatO */
  OPT_gno_ = 1236,                           /* -gno- */
  OPT_gno_pubnames = 1237,                   /* -gno-pubnames */
  OPT_gpubnames = 1238,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1239,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1240,                   /* -gsplit-dwarf */
  OPT_gstabs = 1241,                         /* -gstabs */
  OPT_gstabs_ = 1242,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1243,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1244,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1245,                        /* -gtoggle */
  OPT_gvariable_location_views = 1246,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1247,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1248,                           /* -gvms */
  OPT_gxcoff = 1249,                         /* -gxcoff */
  OPT_gxcoff_ = 1250,                        /* -gxcoff+ */
  OPT_gz = 1251,                             /* -gz */
  OPT_gz_ = 1252,                            /* -gz= */
  OPT_h = 1253,                              /* -h */
  OPT_idirafter = 1254,                      /* -idirafter */
  OPT_imacros = 1255,                        /* -imacros */
  OPT_imultiarch = 1256,                     /* -imultiarch */
  OPT_imultilib = 1257,                      /* -imultilib */
  OPT_include = 1258,                        /* -include */
  OPT_iplugindir_ = 1259,                    /* -iplugindir= */
  OPT_iprefix = 1260,                        /* -iprefix */
  OPT_iquote = 1261,                         /* -iquote */
  OPT_isysroot = 1262,                       /* -isysroot */
  OPT_isystem = 1263,                        /* -isystem */
  OPT_iwithprefix = 1264,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1265,              /* -iwithprefixbefore */
  OPT_k8 = 1266,                             /* -k8 */
  OPT_l = 1267,                              /* -l */
  OPT_lang_asm = 1268,                       /* -lang-asm */
  OPT_mabi_ = 1269,                          /* -mabi= */
  OPT_march_ = 1270,                         /* -march= */
  OPT_mbig_endian = 1271,                    /* -mbig-endian */
  OPT_mbionic = 1272,                        /* -mbionic */
  ...
  OPT_mglibc = 1279,                         /* -mglibc */
  OPT_mlittle_endian = 1280,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1281,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1282,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1283,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1284,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1285,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1286,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1287,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1288,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1289, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1290,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1291,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1292,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1293,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1294,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1295,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1296,             /* -mtrack-speculation */
  OPT_mtune_ = 1297,                         /* -mtune= */
  OPT_muclibc = 1298,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1299,             /* -mverbose-cost-dump */
  OPT_n = 1300,                              /* -n */
  OPT_no_canonical_prefixes = 1301,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1302,              /* -no-integrated-cpp */
  OPT_no_pie = 1303,                         /* -no-pie */
  OPT_nocpp = 1304,                          /* -nocpp */
  OPT_nodefaultlibs = 1305,                  /* -nodefaultlibs */
  OPT_nolibc = 1306,                         /* -nolibc */
  OPT_nophoboslib = 1307,                    /* -nophoboslib */
  OPT_nostartfiles = 1308,                   /* -nostartfiles */
  OPT_nostdinc = 1309,                       /* -nostdinc */
  OPT_nostdinc__ = 1310,                     /* -nostdinc++ */
  OPT_nostdlib = 1311,                       /* -nostdlib */
  OPT_o = 1312,                              /* -o */
  OPT_p = 1313,                              /* -p */
  OPT_pass_exit_codes = 1314,                /* -pass-exit-codes */
  /* OPT_pedantic = 1315, */                 /* -pedantic */
  OPT_pedantic_errors = 1316,                /* -pedantic-errors */
  OPT_pg = 1317,                             /* -pg */
  OPT_pie = 1318,                            /* -pie */
  OPT_pipe = 1319,                           /* -pipe */
  OPT_posix = 1320,                          /* -posix */
  ...
  OPT_profile = 1332,                        /* -profile */
  OPT_pthread = 1333,                        /* -pthread */
  OPT_quiet = 1334,                          /* -quiet */
  OPT_r = 1335,                              /* -r */
  OPT_rdynamic = 1336,                       /* -rdynamic */
  OPT_remap = 1337,                          /* -remap */
  OPT_s = 1338,                              /* -s */
  OPT_save_temps = 1339,                     /* -save-temps */
  OPT_save_temps_ = 1340,                    /* -save-temps= */
  OPT_shared = 1341,                         /* -shared */
  OPT_shared_libgcc = 1342,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1343,               /* -shared-libphobos */
  /* OPT_specs = 1344, */                    /* -specs */
  OPT_specs_ = 1345,                         /* -specs= */
  OPT_static = 1346,                         /* -static */
  OPT_static_libasan = 1347,                 /* -static-libasan */
  OPT_static_libgcc = 1348,                  /* -static-libgcc */
  OPT_static_libgfortran = 1349,             /* -static-libgfortran */
  OPT_static_libgo = 1350,                   /* -static-libgo */
  OPT_static_liblsan = 1351,                 /* -static-liblsan */
  OPT_static_libmpx = 1352,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1353,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1354,               /* -static-libphobos */
  OPT_static_libstdc__ = 1355,               /* -static-libstdc++ */
  OPT_static_libtsan = 1356,                 /* -static-libtsan */
  OPT_static_libubsan = 1357,                /* -static-libubsan */
  OPT_static_pie = 1358,                     /* -static-pie */
  /* OPT_std_c__03 = 1359, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1360, */                /* -std=c++0x */
  OPT_std_c__11 = 1361,                      /* -std=c++11 */
  OPT_std_c__14 = 1362,                      /* -std=c++14 */
  OPT_std_c__17 = 1363,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1364, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1365, */                /* -std=c++1z */
  OPT_std_c__2a = 1366,                      /* -std=c++2a */
  OPT_std_c__98 = 1367,                      /* -std=c++98 */
  OPT_std_c11 = 1368,                        /* -std=c11 */
  OPT_std_c17 = 1369,                        /* -std=c17 */
  /* OPT_std_c18 = 1370, */                  /* -std=c18 */
  /* OPT_std_c1x = 1371, */                  /* -std=c1x */
  OPT_std_c2x = 1372,                        /* -std=c2x */
  ...
  OPT_std_f2018 = 1380,                      /* -std=f2018 */
  OPT_std_f95 = 1381,                        /* -std=f95 */
  OPT_std_gnu = 1382,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1383, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1384, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1385,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1386,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1387,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1388, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1389, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1390,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1391,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1392,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1393,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1394, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1395, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1396,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1397, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1398,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1399,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1400, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1401, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1402,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1403, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1404, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1405, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1406, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1407, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1408,                     /* -std=legacy */
  OPT_symbolic = 1409,                       /* -symbolic */
  OPT_t = 1410,                              /* -t */
  OPT_time = 1411,                           /* -time */
  OPT_time_ = 1412,                          /* -time= */
  OPT_traditional = 1413,                    /* -traditional */
  OPT_traditional_cpp = 1414,                /* -traditional-cpp */
  OPT_trigraphs = 1415,                      /* -trigraphs */
  OPT_u = 1416,                              /* -u */
  OPT_undef = 1417,                          /* -undef */
  OPT_v = 1418,                              /* -v */
  OPT_version = 1419,                        /* -version */
  OPT_w = 1420,                              /* -w */
  OPT_wrapper = 1421,                        /* -wrapper */
  OPT_x = 1422,                              /* -x */
  OPT_z = 1423,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
